...
public class GoogleSheetsService {
    ...
    public List<List<Object>> importDataFromSheet(String spreadsheetId, String range) throws IOException, GeneralSecurityException {
    ...
    public void exportDataToSheet(String spreadsheetId, String range, List<List<Object>> values) throws IOException, GeneralSecurityException {
        Sheets service = getSheetsService();
